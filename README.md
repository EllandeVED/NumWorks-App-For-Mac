...
- You will be faced with this message when trying to open the app (because I don't have a registered develloper ID):
...
- You need to delete the old version and replace it with the new one
